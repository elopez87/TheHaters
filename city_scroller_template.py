...
class Scroller(object):
    ...
    def __init__(self, width, height, base, color, speed):
        ...
        self.speed = speed
        self.building = []
        self.add_buildings() #add building each time a new instance is created 
    ...
    def add_buildings(self):
        ...
        while current_width <= self.width:
            ...
            current_width += self.building[-1].width
    ...
    def add_building(self, x_location):
        ...
        self.building.append(Building(x_location,y_location, building_width, building_height, self.color ))
    ...
    def move_buildings(self):
        ...
        new_building_location = self.building[-1].x_point + self.building[-1].width
        if new_building_location <= SCREEN_WIDTH:
