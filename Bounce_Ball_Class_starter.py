...
class BouncingBall(): 
    ...
    # Attributes of the bouncing ball 
        ...
        self.ball_size = random.randint(10,30)
    ...
    def flashBounce(self, screen, colors, screen_width, screen_height):
       # self.ball_size = random.randint(5,50)
...
ball_1 = BouncingBall(350, 250, 4, 5)
ball_2 = BouncingBall(350, 250, 5, 5)
ball_3 = BouncingBall(350, 250, 6, 5)
ball_4 = BouncingBall(350, 250, 4, 6)
ball_5 = BouncingBall(350, 250, 4, 7)
	# -------- Main Program Loop -----------
while not done:
    # --- Main event loop
    ...
    ball_1.flashBounce(screen, ball_color, SCREEN_WIDTH, SCREEN_HEIGHT)
    ball_2.flashBounce(screen, ball_color, SCREEN_WIDTH, SCREEN_HEIGHT)
    ball_3.flashBounce(screen, ball_color, SCREEN_WIDTH, SCREEN_HEIGHT)
    ball_4.flashBounce(screen, ball_color, SCREEN_WIDTH, SCREEN_HEIGHT)
    ball_5.flashBounce(screen, ball_color, SCREEN_WIDTH, SCREEN_HEIGHT)
